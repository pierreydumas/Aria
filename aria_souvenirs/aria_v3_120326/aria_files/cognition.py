...
class Cognition:
    ...
    async def process(
        ...
        # Step 2.05: SP7-04 — Dynamic focus auto-switching
        # Detect the best focus for this task and switch before processing.
        # The model hint, system prompt overlay, and skill affinity all change.
        try:
